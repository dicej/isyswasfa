                    ...
                    TypeDefKind::Future(ty) => {
                        ...
                        let new_id = if let Some(future_ty) = self.future_types.get(&ty) {
                            *future_ty
                            ...
                            let send_name = format!("isyswasfa-send-{element_name}");
                            let send = Function {
                            ...
                            let receive_start_name =
                                format!("isyswasfa-receive-{element_name}-isyswasfa-start");
                            let receive_start = Function {
                                ...
                                results: Results::Anon(Type::Id(self.map_result_type(ty))),
                                docs: Docs::default(),
                            };

                            let receive_result_name =
                                format!("isyswasfa-receive-{element_name}-isyswasfa-result");
